    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <h3 class="text-center text-danger">
                <b><font color="blue"> THÊM NHÂN VIÊN</font></b>
            </h3>
            <form @submit.prevent="handleSubmitForm">
                <div class="form-group">
                    <label>Mã nhân viên</label>
                    <input type="text" class="form-control" v-model="staff.Id" required>
                </div>
                <div class="form-group">
                    <label>Tên</label>
                ...
                <div class="form-group">
                    <button class="btn btn-danger btn-block" @click="goToAddStaff" style="background:orange"><i class="fa-regular fa-floppy-disk"></i> THÊM MỚI</button>
                </div>
            </form>
        </div>
    </div>
